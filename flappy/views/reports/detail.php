<div id="main" class="report_detail">
	<?PHP
		//$this->template->kohana_local_data['header']->kohana_local_data['uri_segments'][2]
		//$this->template->kohana_local_data['header']->kohana_local_data['header_nav']->kohana_local_data['loggedin_user']->id
	?>
	<div class="left-col">
		...
		<h1 class="report-title"><?php
			...
			if ($logged_in)
			{
				$block = new edit_blocks();
				$block->block($this->template->kohana_local_data['header']->kohana_local_data['header_nav']->kohana_local_data['loggedin_user']->id,$this->template->kohana_local_data['header']->kohana_local_data['uri_segments'][2]);
			}
		?></h1>
